...
средства мониторинга hw: локальный Prometheus+ grafana
    ...
    -  результатНе достигнут:
    -  ![результат](https://github.com/Romanru5116/AI/blob/2acaa6836cd4fcb16d45db99708b1d7b38db9b76/PIC/ScreenshotOpenwbUIinstall%20%20from%202026-06-26%2011-02-31.png)
