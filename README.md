...
средства мониторинга hw: локальный Prometheus+ grafana
    ...
    -  ЦЕЛЬ исследования: нагружает ли AI вообще процессор и логику ответов.
    -  Задача: решить задачу
    - на здравый смысл и физикуЧто проверяет: Способность применять базовые законы физики и логики, недоступные при простом поиске по тексту.Пример задачи (Winograd Schema Challenge):У нас есть узкий деревянный ящик и металлическая труба. Труба идеально подходит по диаметру, чтобы поместиться в ящик. Ящик имеет длину 2 метра, а труба имеет длину 3 метра. Как можно полностью спрятать трубу внутри ящика?
    - на картинке слева ифраметрики, справа вверху -задача и ответы ИИ, справа внизу - окно для тайминга обработки.
       ВЫВОДЫ ТАКИЕ: влияние работы ИИ на потребление ресурсов незаметно, логика ответа понятная,придется усложнять условия.
  ![графики](https://github.com/Romanru5116/AI/blob/3ff72fa8d54cd51ef8d6fe22fa76c24058c46138/PIC/ScreenshotExperiment1%20from%202026-06-30%2019-17-26.png)
