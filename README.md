...
придется искать видимо другую llM- deepseek или gemini в инете которые-выглядят поинтересне.
статус: 2406
надо искать модельку посвежее, ответы имеющейся версии больше описательные типа "можно погуглить по таким словам"
СТАТУС: 2306
...
материалы общих знаний просуть ИИ- токены и вот это вот все просто и наглядно 
