...
средства мониторинга hw: локальный Prometheus+ grafana
    ...
    -  ЦЕЛЬ исследования: нагружает ли AI вообще процессор
       на картинке слева ифраметрики, справа вверух -задача и ответы ИИ, справа внизу - окно для тайминга обработки.
       ВЫВОДЫ ТАКИЕ: влияние работы ИИ на потребление ресурсов незаметно
